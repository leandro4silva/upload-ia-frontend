          ...
          <form action="" className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Slider
                ...
                step={0.1}
              />
              <span className="block text-xs text-muted-foreground italic leading-relaxed">Valores mais altos tendem a deixar o resultado mais criativo e com possiveis errors.</span>
            </div>
